...
class MyDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        keypoints[:, 0] = keypoints[:, 0] / image.shape[1]  # Normalize x-coordinates
        keypoints[:, 1] = keypoints[:, 1] / image.shape[0]  # Normalize y-coordinates
...
def train_network(workers=8):
    ...
    train_dataset = MyDataset("C:/Users/crisz/Documents/ECU Classes/CSCI Graduate/Thesis/train", filter=True)
    validation_dataset = MyDataset("C:/Users/crisz/Documents/ECU Classes/CSCI Graduate/Thesis/validation", filter=True)
