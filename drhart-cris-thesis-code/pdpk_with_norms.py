...
# Assuming Depth-Anything-V2 is in the parent directory of the project root
...
def main():
    parser = argparse.ArgumentParser(description='Process garment images to calculate measurements.')
    ...
    dataset = DrHartCrisDataset(args.image_dirs)
    if len(dataset) == 0:
